---
name: phase_5_repair_thumbnails
description: "YouTube thumbnail setter using Google API. Token file path is hardcoded to youtube_token.pickle (must be trusted). Override via function argument if needed."
version: 1.0.0
category: automation
---
# Phase 5 Repair Thumbnails

YouTube thumbnail setter using Google API. Token file path is hardcoded to youtube_token.pickle (must be trusted). Override via function argument if needed.
